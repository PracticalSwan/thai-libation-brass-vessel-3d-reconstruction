...
- **Professor submission package:** `submission/` — verified GLB and PLY deliverables, 9 final model images, README, and SHA-256 manifest
...
The root-level `submission/` folder is the compact handoff intended for the professor. Its ready state contains `Thai_Libation_Vessel_Final.glb`, `Thai_Libation_Vessel_Final.ply`, eight 45-degree turntable images, one turntable contact sheet, `README.txt`, and `SHA256SUMS.txt`. The GLB preserves the final brass material; the PLY is a binary triangulated geometry-and-normals export. Both were imported into fresh Blender 5.2 factory-startup scenes and reproduced the final V139 topology of **451,312 vertices / 902,838 triangles** and matching scene-space dimensions. The GLB SHA-256 is `38a38dc17d23a4a19ecd991b6c4ff8023814b9d17fa6fbb13d0c78fe3e3f1ad6`; the PLY SHA-256 is `42ab10ebec3b69dc8dc7ce28463a9d04fd3f0ecb3b35f888b62bc3c222eb9ff1`.
...
The final formatted paper is included as both `docs/Thai_Libation_Brass_Vessel_Final_Report.docx` and `docs/Thai_Libation_Brass_Vessel_Final_Report.pdf`.
