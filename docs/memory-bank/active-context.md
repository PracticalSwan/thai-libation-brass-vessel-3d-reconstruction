...
The material is `MAT_V4_V115_BrassStatsOnly` from the verified 158-image appearance statistics (`photographic_projection_verified=false`). Final clay QA covers nine segmented surface bands plus the full turntable, four top-oblique views and underside views; final brass QA covers an eight-angle turntable and closeups. V139 has been promoted to `reconstruction/v4/blender/Thai_Libation_Vessel_V4_FINAL.blend` (SHA-256 `6663d83303fefac34bbbee85132ad64322e2e9b0bc4db73776f2a882a9d07a0c`) and exported to `Thai_Libation_Vessel_V4_FINAL.glb` (SHA-256 `38a38dc17d23a4a19ecd991b6c4ff8023814b9d17fa6fbb13d0c78fe3e3f1ad6`). A fresh Blender 5.2 factory-startup import verified exactly one mesh with matching 451,312 vertices / 902,838 triangles, material, transforms and dimensions.
