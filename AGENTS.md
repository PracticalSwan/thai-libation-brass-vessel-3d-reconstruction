...
- The user explicitly authorized final export/promotion on 2026-09-17. V139 is now promoted to `reconstruction/v4/blender/Thai_Libation_Vessel_V4_FINAL.blend` and `reconstruction/v4/blender/Thai_Libation_Vessel_V4_FINAL.glb`. Canonical SHA-256 values are `6663d83303fefac34bbbee85132ad64322e2e9b0bc4db73776f2a882a9d07a0c` for the `.blend` and `38a38dc17d23a4a19ecd991b6c4ff8023814b9d17fa6fbb13d0c78fe3e3f1ad6` for the GLB. A fresh Blender 5.2 factory-startup import verified exactly one V139 mesh with 451,312 vertices / 902,838 triangles, `MAT_V4_V115_BrassStatsOnly`, identity transforms, and matching dimensions. Further canonical geometry/export changes require a new explicit scope.